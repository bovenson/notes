...
阅读[使用GPU](http://wiki.jikexueyuan.com/project/tensorflow-zh/get_started/tensorflow-zh/SOURCE/how_tos/using_gpu.html)章节, 了解 TensorFlow GPU 使用的更多信息.
