...
from time_tensorflow_run import time_tensorflow_run
...
def resnet_v2_50(inputs, num_classes=None, global_pool=True, reuse=None, scope='resnet_v2_50'):
    ...
    return resnet_v2(inputs, blocks, num_classes=num_classes, global_pool=global_pool, include_root_block=True, reuse=reuse, scope=scope)
